    ...
    <div class="container mt-3">
        ...
        <table class="table"> 
            ...
            foreach ($counpons as $item) {
                ...
                echo "<td> <a class='btn btn-danger' href='delete.php?id=$item[idCoupons]'>remove</a>
                    <a class='btn btn-info' href='update.php?id=$item[idCoupons]'>update</a>
                </td>";
                echo "</tr>";
            }
